import{i as r,s as _,c as f}from"./assets/footer-subscription-115f49fa.js";import"./assets/vendor-8a888f22.js";const o=document.querySelector(".cart");JSON.parse(localStorage.getItem("cart-products-list"));const S=e=>{const t=e.map(({_id:c,name:a,img:l,category:s,price:h,size:b,popularity:x,quantity:N,is10PercentOff:P,desc:w})=>`<li class="card_container_product" id="${c}">
