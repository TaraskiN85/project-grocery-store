import"./assets/styles-3bfe271a.js";const r=document.querySelector(".cart-list"),p=JSON.parse(localStorage.getItem("cart-products-list")),_=t=>t.map(({_id:e,name:c,img:o,category:i,price:l,size:u,popularity:L,quantity:h,is10PercentOff:k,desc:C})=>`<li class="card_container_product" id="${e}">
