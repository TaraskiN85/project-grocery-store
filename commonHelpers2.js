import{i as d,g as m,a as ct,b as ot,d as at,e as rt}from"./assets/footer-subscription-37f98d9c.js";import{P as B}from"./assets/vendor-8a888f22.js";const E=document.querySelector(".scroll_up");window.addEventListener("scroll",nt);E.addEventListener("click",T);function nt(){window.scrollY>350?E.classList.add("visible"):E.classList.remove("visible")}function T(){window.scrollY>0&&(window.scrollBy(0,-40),setTimeout(T,0))}const A={divProdCards:document.querySelector(".js-product-cards")};function P(e){A.divProdCards.innerHTML="",A.divProdCards.insertAdjacentHTML("afterbegin",it(e))}function it(e){return e.results.length===0?`<div clas="products-nothing-container">
