import{g as m,a as st,b as ct,d as ot,e as at}from"./assets/footer-subscription-a77f422b.js";import{P as B}from"./assets/vendor-8a888f22.js";const E=document.querySelector(".scroll_up");window.addEventListener("scroll",rt);E.addEventListener("click",A);function rt(){window.scrollY>350?E.classList.add("visible"):E.classList.remove("visible")}function A(){window.scrollY>0&&(window.scrollBy(0,-40),setTimeout(A,0))}const $={divProdCards:document.querySelector(".js-product-cards")};function S(e){$.divProdCards.innerHTML="",$.divProdCards.insertAdjacentHTML("afterbegin",nt(e))}function nt(e){return e.results.length===0?`<div clas="products-nothing-container">
          ...
          <div class="aside-product-card" id="${t}">
              ...
              </div>`).join("")}async function pt(){const e=await ct();D.discountProductCards.insertAdjacentHTML("beforeend",gt(e))}function gt(e){return e.slice(0,2).map(({_id:s,name:i,img:l,price:n})=>`<div class="container-for-discount-items" id="${s}">
